...
// GetDeadMansSwitch returns a DeadMansSwitch struct. This struct
...
// the current time rather than from when the GetDeadMansSwitch was
// returned. In other words, this lets you get notified automatically
// some time after a process stops sending events.
func GetDeadMansSwitch(timeout time.Duration) *DeadMansSwitch {
